...
df <- df%>%as_tibble()%>%mutate_if(is.integer,as.factor)
ns <- 5000
ps <- 150
r <- 1000
pt <- 50
...
timestart <- Sys.time()
prunex1_1 <- stepPrune(df1,dfgwas1,1e-8,0.1)
print(prunex1_1)
prunex1_2 <- stepPrune(df1,dfgwas1,1e-8,0.3)
print(prunex1_2)
prunex1_3 <- stepPrune(df1,dfgwas1,1e-8,0.5)
print(prunex1_3)
timeend <- Sys.time()
...
timestart <- Sys.time()
prunex2_1 <- stepPrune(df2,dfgwas2,1e-8,0.1)
print(prunex2_1)
prunex2_2 <- stepPrune(df2,dfgwas2,1e-8,0.3)
print(prunex2_2)
prunex2_3 <- stepPrune(df2,dfgwas2,1e-8,0.5)
print(prunex2_3)
timeend <- Sys.time()
...
ldre1 <- tibble(pthres=1e-8,cut=c(0.1,0.3,0.5),len=len1,rec=rec1,t=t1/3)
ldre2 <- tibble(pthres=1e-8,cut=c(0.1,0.3,0.5),len=len2,rec=rec2,t=t2/3)


timestart <- Sys.time()
prunex1_1 <- stepPrune(df1,dfgwas1,1e-6,0.1)
print(prunex1_1)
prunex1_2 <- stepPrune(df1,dfgwas1,1e-6,0.3)
print(prunex1_2)
prunex1_3 <- stepPrune(df1,dfgwas1,1e-6,0.5)
print(prunex1_3)
timeend <- Sys.time()
t1 <- difftime(timeend,timestart,units="min")
len1 <- c(length(prunex1_1),length(prunex1_2),length(prunex1_3))
...
timestart <- Sys.time()
prunex2_1 <- stepPrune(df2,dfgwas2,1e-6,0.1)
print(prunex2_1)
prunex2_2 <- stepPrune(df2,dfgwas2,1e-6,0.3)
print(prunex2_2)
prunex2_3 <- stepPrune(df2,dfgwas2,1e-6,0.5)
print(prunex2_3)
timeend <- Sys.time()
t2 <- difftime(timeend,timestart,units="min")
...
ldre1 <- ldre1 %>% bind_rows(tibble(pthres=1e-6,cut=c(0.1,0.3,0.5),len=len1,rec=rec1,t=t1/3))
ldre2 <- ldre2 %>% bind_rows(tibble(pthres=1e-6,cut=c(0.1,0.3,0.5),len=len2,rec=rec2,t=t2/3))

timestart <- Sys.time()
prunex1_1 <- stepPrune(df1,dfgwas1,1e-4,0.1)
print(prunex1_1)
prunex1_2 <- stepPrune(df1,dfgwas1,1e-4,0.3)
print(prunex1_2)
prunex1_3 <- stepPrune(df1,dfgwas1,1e-4,0.5)
print(prunex1_3)
timeend <- Sys.time()
t1 <- difftime(timeend,timestart,units="min")
len1 <- c(length(prunex1_1),length(prunex1_2),length(prunex1_3))
...
timestart <- Sys.time()
prunex2_1 <- stepPrune(df2,dfgwas2,1e-4,0.1)
print(prunex2_1)
prunex2_2 <- stepPrune(df2,dfgwas2,1e-4,0.3)
print(prunex2_2)
prunex2_3 <- stepPrune(df2,dfgwas2,1e-4,0.5)
print(prunex2_3)
timeend <- Sys.time()
t2 <- difftime(timeend,timestart,units="min")
len2 <- c(length(prunex2_1),length(prunex2_2),length(prunex2_3))
...
ldre1 <- ldre2 %>% bind_rows(tibble(pthres=1e-4,cut=c(0.1,0.3,0.5),len=len1,rec=rec1,t=t1/3)) %>% write_csv("idprune_x1.csv")
ldre2 <- ldre2 %>% bind_rows(tibble(pthres=1e-4,cut=c(0.1,0.3,0.5),len=len2,rec=rec2,t=t2/3)) %>% write_csv("idprune_x2.csv")
