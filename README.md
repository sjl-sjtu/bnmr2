...
### * An integrated example using R package `bnmr` and Python library PyMC to handle large scale data from UK Biobank
The tutorial for the integrated example is shown at https://github.com/sjl-sjtu/bnmr/blob/main/BayesianMR_pymc_tutorial.md.
