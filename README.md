...
* `bn_method`: We implement BN learning with algorithms provided by R package `bnlearn` (https://www.bnlearn.com/), including contraint-based, score-based, and hybrid approaches. In our simulations, the Hill-Climbing (hc) algorithm is the fastest, and although other methods are more accurate, hc is able to meet the requirements under mundane situations.
...
* Numbers of iterations and chains: We endorse the use of at least 4 chains and at least 2000 iterations per chain in MCMC.
